    ...
    % for i in images:
        % for t in i['RepoTags']:
            <tr>
                ...
                <td><button class="btn btn-link" data-toggle="modal" data-target="#create_container_modal"><span style="color:#080" class="glyphicon glyphicon-new-window"></span></button> &nbsp;&nbsp;
...
<div class="modal fade" id="create_container_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
