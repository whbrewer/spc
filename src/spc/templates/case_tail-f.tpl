...
<button style="position:fixed; bottom:200px; right:-5px" class="cd-top btn btn-primary" onclick="scrollToTop()"><span class="glyphicon glyphicon-menu-up"></span></button>
...
<button id="pause" style="position:fixed; bottom:150px; right:-5px" class="cd-top btn btn-primary"><span id="pause_str" class="glyphicon glyphicon-pause"></span></button>
...
/* js-logtail https://github.com/ukhas/js-logtail */
...
var url = "user_data/{{user}}/{{app}}/{{cid}}/{{app}}.out";
var fix_rn = true;
...
function get_log() {
    ...
    if (log_file_size === 0) {
        ...
        first_load = false;
        must_get_206 = false; //log_file_size > 1;
    }
...
$(document).ready(function () {
    ...
    $(pausetoggle).click(function (e) {
        pause = !pause;
        $("#pause_str").toggleClass("glyphicon-pause glyphicon-play")
        show_log();
        e.preventDefault();
    });
